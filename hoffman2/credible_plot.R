...
ids <- sample(1:2501, 1000)
beta_MCMC1 <- beta_MCMC1[ids, ]
beta_MCMC2 <- beta_MCMC2[ids, ]
names(beta_MCMC1) = names(beta_MCMC2) = c("beta0", "beta1")
...
# post_beta500 <- melt(post_beta500, id.vars = "Method")
# p2 <- ggplot(data = post_beta500, aes(x = value)) +
